            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="contact-form">
                        <form  method = "POST" action="./PHP/encodeNews.php">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                <label for="titre">Votre titre  :</label>
                                    <input type="text" class="form-control" name="titre" placeholder="Votre titre"
                                        required="required" />
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control"  placeholder="date Expiration" name="date"/>
                            </div>
                            <div class="form-group">  
                            <label for="news">Votre News  :</label>          
                                <textarea class="form-control" required="required" name="news" rows="5" placeholder="Votre news "></textarea>
                            </div>
